  ...
  return (
    <main className="flex flex-1 h-full flex-wrap justify-center items-center w-full">
      <Card className="flex flex-col items-center">
        <h1 className="text-2xl">Me Envie Uma Mensagem</h1>
        ...
        <form className="flex flex-col p-5">
          ...
          <textarea
            rows={10}
            cols={10}
            className="mb-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 resize-none"
          />
          <button
            type="submit"
